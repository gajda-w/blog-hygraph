...
export type AssetKeySpecifier = ('authorAvatar' | 'coverImagePost' | 'createdAt' | 'createdBy' | 'documentInStages' | 'fileName' | 'handle' | 'height' | 'history' | 'id' | 'locale' | 'localizations' | 'mimeType' | 'publishedAt' | 'publishedBy' | 'scheduledIn' | 'seoImage' | 'size' | 'stage' | 'updatedAt' | 'updatedBy' | 'url' | 'width' | AssetKeySpecifier)[];
export type AssetFieldPolicy = {
	authorAvatar?: FieldPolicy<any> | FieldReadFunction<any>,
	coverImagePost?: FieldPolicy<any> | FieldReadFunction<any>,
	...
	seoImage?: FieldPolicy<any> | FieldReadFunction<any>,
...
export type AuthorKeySpecifier = ('biography' | 'createdAt' | 'createdBy' | 'documentInStages' | 'history' | 'id' | 'name' | 'picture' | 'posts' | 'publishedAt' | 'publishedBy' | 'scheduledIn' | 'stage' | 'title' | 'updatedAt' | 'updatedBy' | AuthorKeySpecifier)[];
...
export type MutationKeySpecifier = ('createAsset' | 'createAuthor' | 'createPage' | 'createPost' | 'createScheduledRelease' | 'createSeo' | 'deleteAsset' | 'deleteAuthor' | 'deleteManyAssets' | 'deleteManyAssetsConnection' | 'deleteManyAuthors' | 'deleteManyAuthorsConnection' | 'deleteManyPages' | 'deleteManyPagesConnection' | 'deleteManyPosts' | 'deleteManyPostsConnection' | 'deleteManySeos' | 'deleteManySeosConnection' | 'deletePage' | 'deletePost' | 'deleteScheduledOperation' | 'deleteScheduledRelease' | 'deleteSeo' | 'publishAsset' | 'publishAuthor' | 'publishManyAssets' | 'publishManyAssetsConnection' | 'publishManyAuthors' | 'publishManyAuthorsConnection' | 'publishManyPages' | 'publishManyPagesConnection' | 'publishManyPosts' | 'publishManyPostsConnection' | 'publishManySeos' | 'publishManySeosConnection' | 'publishPage' | 'publishPost' | 'publishSeo' | 'schedulePublishAsset' | 'schedulePublishAuthor' | 'schedulePublishPage' | 'schedulePublishPost' | 'schedulePublishSeo' | 'scheduleUnpublishAsset' | 'scheduleUnpublishAuthor' | 'scheduleUnpublishPage' | 'scheduleUnpublishPost' | 'scheduleUnpublishSeo' | 'unpublishAsset' | 'unpublishAuthor' | 'unpublishManyAssets' | 'unpublishManyAssetsConnection' | 'unpublishManyAuthors' | 'unpublishManyAuthorsConnection' | 'unpublishManyPages' | 'unpublishManyPagesConnection' | 'unpublishManyPosts' | 'unpublishManyPostsConnection' | 'unpublishManySeos' | 'unpublishManySeosConnection' | 'unpublishPage' | 'unpublishPost' | 'unpublishSeo' | 'updateAsset' | 'updateAuthor' | 'updateManyAssets' | 'updateManyAssetsConnection' | 'updateManyAuthors' | 'updateManyAuthorsConnection' | 'updateManyPages' | 'updateManyPagesConnection' | 'updateManyPosts' | 'updateManyPostsConnection' | 'updateManySeos' | 'updateManySeosConnection' | 'updatePage' | 'updatePost' | 'updateScheduledRelease' | 'updateSeo' | 'upsertAsset' | 'upsertAuthor' | 'upsertPage' | 'upsertPost' | 'upsertSeo' | MutationKeySpecifier)[];
export type MutationFieldPolicy = {
	...
	createSeo?: FieldPolicy<any> | FieldReadFunction<any>,
	...
	deleteManySeos?: FieldPolicy<any> | FieldReadFunction<any>,
	deleteManySeosConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	...
	deleteSeo?: FieldPolicy<any> | FieldReadFunction<any>,
	...
	publishManySeos?: FieldPolicy<any> | FieldReadFunction<any>,
	publishManySeosConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	publishPage?: FieldPolicy<any> | FieldReadFunction<any>,
	publishPost?: FieldPolicy<any> | FieldReadFunction<any>,
	publishSeo?: FieldPolicy<any> | FieldReadFunction<any>,
	...
	schedulePublishPost?: FieldPolicy<any> | FieldReadFunction<any>,
	schedulePublishSeo?: FieldPolicy<any> | FieldReadFunction<any>,
	...
	scheduleUnpublishPost?: FieldPolicy<any> | FieldReadFunction<any>,
	scheduleUnpublishSeo?: FieldPolicy<any> | FieldReadFunction<any>,
	...
	unpublishManySeos?: FieldPolicy<any> | FieldReadFunction<any>,
	unpublishManySeosConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	unpublishPage?: FieldPolicy<any> | FieldReadFunction<any>,
	unpublishPost?: FieldPolicy<any> | FieldReadFunction<any>,
	unpublishSeo?: FieldPolicy<any> | FieldReadFunction<any>,
	...
	updateManySeos?: FieldPolicy<any> | FieldReadFunction<any>,
	updateManySeosConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	updatePage?: FieldPolicy<any> | FieldReadFunction<any>,
	updatePost?: FieldPolicy<any> | FieldReadFunction<any>,
	updateScheduledRelease?: FieldPolicy<any> | FieldReadFunction<any>,
	updateSeo?: FieldPolicy<any> | FieldReadFunction<any>,
	...
	upsertSeo?: FieldPolicy<any> | FieldReadFunction<any>
};
...
export type PageKeySpecifier = ('content' | 'createdAt' | 'createdBy' | 'documentInStages' | 'history' | 'id' | 'publishedAt' | 'publishedBy' | 'scheduledIn' | 'seo' | 'slug' | 'stage' | 'subtitle' | 'title' | 'updatedAt' | 'updatedBy' | PageKeySpecifier)[];
...
export type PostKeySpecifier = ('author' | 'content' | 'coverImage' | 'createdAt' | 'createdBy' | 'date' | 'documentInStages' | 'excerpt' | 'history' | 'id' | 'publishedAt' | 'publishedBy' | 'scheduledIn' | 'seo' | 'slug' | 'stage' | 'tags' | 'title' | 'updatedAt' | 'updatedBy' | PostKeySpecifier)[];
...
export type PostConnectionKeySpecifier = ('aggregate' | 'edges' | 'pageInfo' | PostConnectionKeySpecifier)[];
...
export type QueryKeySpecifier = ('asset' | 'assetVersion' | 'assets' | 'assetsConnection' | 'author' | 'authorVersion' | 'authors' | 'authorsConnection' | 'node' | 'page' | 'pageVersion' | 'pages' | 'pagesConnection' | 'post' | 'postVersion' | 'posts' | 'postsConnection' | 'scheduledOperation' | 'scheduledOperations' | 'scheduledOperationsConnection' | 'scheduledRelease' | 'scheduledReleases' | 'scheduledReleasesConnection' | 'seo' | 'seoVersion' | 'seos' | 'seosConnection' | 'user' | 'users' | 'usersConnection' | QueryKeySpecifier)[];
export type QueryFieldPolicy = {
	...
	seo?: FieldPolicy<any> | FieldReadFunction<any>,
	seoVersion?: FieldPolicy<any> | FieldReadFunction<any>,
	seos?: FieldPolicy<any> | FieldReadFunction<any>,
	seosConnection?: FieldPolicy<any> | FieldReadFunction<any>,
...
export type SeoKeySpecifier = ('createdAt' | 'createdBy' | 'description' | 'documentInStages' | 'history' | 'id' | 'image' | 'keywords' | 'parent' | 'publishedAt' | 'publishedBy' | 'scheduledIn' | 'stage' | 'title' | 'updatedAt' | 'updatedBy' | SeoKeySpecifier)[];
...
export type SeoConnectionKeySpecifier = ('aggregate' | 'edges' | 'pageInfo' | SeoConnectionKeySpecifier)[];
export type SeoConnectionFieldPolicy = {
	aggregate?: FieldPolicy<any> | FieldReadFunction<any>,
	edges?: FieldPolicy<any> | FieldReadFunction<any>,
	pageInfo?: FieldPolicy<any> | FieldReadFunction<any>
};
export type SeoEdgeKeySpecifier = ('cursor' | 'node' | SeoEdgeKeySpecifier)[];
export type SeoEdgeFieldPolicy = {
	cursor?: FieldPolicy<any> | FieldReadFunction<any>,
	node?: FieldPolicy<any> | FieldReadFunction<any>
};
...
export type StrictTypedTypePolicies = {
	...
	SeoConnection?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | SeoConnectionKeySpecifier | (() => undefined | SeoConnectionKeySpecifier),
		fields?: SeoConnectionFieldPolicy,
	},
	SeoEdge?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | SeoEdgeKeySpecifier | (() => undefined | SeoEdgeKeySpecifier),
		fields?: SeoEdgeFieldPolicy,
	},
